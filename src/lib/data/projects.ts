...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Aquired knowledge in SvelteKit, while handling authentication, form validations, image uploads, database manipulations, emails, etc..',
  ...
  },
  {
    ...
    description: 'In order to learn NextJS, I developed this project, which contains authentication, all CRUD Operations, cache, a text editor, etc..',
  ...
  },
  {
    ...
    description: "This web application allows users to share their creative prompts and browse other's.",
